...
import { createClienteRequest, checkEmailExistsAsClienteRequest } from '../../../api/clientes.api';
        ...
        onSubmit={async (values, { setSubmitting, setErrors }) => {
          try {
            if (step === 1) {
              ...
              const emailExists = await checkEmailExistsAsClienteRequest(values.usuario_email);
              if (emailExists.data.exists) {
                setErrors({ usuario_email: 'El correo electrónico ya está registrado como cliente' });
                setSubmitting(false);
                return;
              }
